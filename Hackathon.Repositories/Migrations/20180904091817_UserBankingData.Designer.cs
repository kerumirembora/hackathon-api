...
namespace Hackathon.Repositories.Migrations
{
    ...
    [Migration("20180904091817_UserBankingData")]
    partial class UserBankingData
    {
            ...
            modelBuilder.Entity("Hackathon.Model.User", b =>
                {
                    ...
                    b.Property<string>("DestinationSavingsAccountId");

                    b.Property<string>("Email");

                    b.Property<string>("Name");

                    b.Property<string>("OriginDepositAccountId");

                    b.Property<long>("SbankenCustomerId");
                    ...
                    b.HasData(
                        new { Id = 1, Age = 32, DestinationSavingsAccountId = "88E0F99D3E11010C971AA1B9127D2E4E", Email = "johndoe@gmail.com", Name = "John Doe", OriginDepositAccountId = "BE674A52B05850EC1E9E7EBBEB75BC45", SbankenCustomerId = 10128512336L, UserName = "JohnDoe" },
                        new { Id = 2, Age = 45, DestinationSavingsAccountId = "2A2B1758EDAB9101D744F7A777EC33D8", Email = "annadoe@outlook.com", Name = "Anna Doe", OriginDepositAccountId = "E7963591FDA781A1912083390CCF6F3A", SbankenCustomerId = 14093623453L, UserName = "AnnaDoe" },
                        new { Id = 3, Age = 28, Email = "jimmy@gmail.com", Name = "Jimmy Chamberlin", SbankenCustomerId = 0L, UserName = "Jimmy" },
                        new { Id = 5, Age = 55, Email = "dominic@yahoo.com", Name = "Dominic Howard", SbankenCustomerId = 0L, UserName = "Dominic" }
                    );
                });
